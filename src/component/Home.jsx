...
const Home = () => {
  return (
    <div className="mt-17 pt-6">
      {/* Background Section */}
      <div className="h-[100vh] w-[95vw] mx-[2vw] bg-gray-600 rounded-2xl bg-[url(https://cdn.prod.website-files.com/6814fd6e7e1d7b88832c570c/681f30291cb42df385279ff2_property02.webp)] bg-cover bg-no-repeat bg-[center_42%] flex items-center">
