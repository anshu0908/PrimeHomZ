...
const Remarkable = () => {
  return (
<<<<<<< HEAD:src/component/remarkable.jsx
    <div className='h-[140vh] w-[95vw] mx-[2vw] mt-23  bg-[#3B3E2D] pt-20 pb-20 px-19 rounded-2xl flex flex-col gap-17'>
=======
    <div className='h-[140vh] w-full mt-7  bg-[#3B3E2D] pt-20 pb-20 px-19 flex flex-col gap-17'>
...
=======
      <div className="lower-div h-[60vh] w-[78vw] grid grid-cols-[57%_38%] gap-[5%] ">

      <div className="left h-[60vh] border-transparent border rounded-2xl">
        <img className='h-full w-45vw object-cover' src="/remarkable image.webp" alt="" />
      </div>
